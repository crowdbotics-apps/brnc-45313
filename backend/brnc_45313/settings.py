"""
Django settings for brnc_45313 project.
...
WSGI_APPLICATION = 'brnc_45313.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "brnc_45313 API",
    "DESCRIPTION": "API documentation for brnc_45313 App",
    "VERSION": "v1",
}
